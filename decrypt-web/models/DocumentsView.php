 ...
 * Page class
 */
class DocumentsView extends Documents
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentsView";
    ...
    // CSS class/style
    public $CurrentPageName = "DocumentsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "DocumentsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "DocumentsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
