 ...
 * Page class
 */
class DataInProjectGrid extends DataInProject
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DataInProjectGrid";
    ...
    public $FormName = "fdata_in_projectgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "DataInProjectGrid";
    ...
    {
        global $CurrentForm;
        if ($CurrentForm->hasValue("x_id") && $CurrentForm->hasValue("o_id") && $this->id->CurrentValue != $this->id->DefaultValue) {
            return false;
        }
