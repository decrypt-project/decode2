...
/**
 * Table class for data_in_project
 */
class DataInProject extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "data_in_project";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // key
        $this->_key = new DbField(
            $this, // Table
            'x__key', // Variable name
            'key', // Name
            '`key`', // Expression
            '`key`', // Basic search expression
            201, // Type
            256, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`key`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->_key->InputTextType = "text";
        $this->_key->Nullable = false; // NOT NULL field
        $this->_key->Required = true; // Required field
        $this->_key->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "data_in_project";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("DataInProjectList");
    }
    ...
    {
        global $Language;
        if ($pageName == "DataInProjectView") {
            return $Language->phrase("View");
        } elseif ($pageName == "DataInProjectEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "DataInProjectAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "DataInProjectView";
            case Config("API_ADD_ACTION"):
                return "DataInProjectAdd";
            case Config("API_EDIT_ACTION"):
                return "DataInProjectEdit";
            case Config("API_DELETE_ACTION"):
                return "DataInProjectDelete";
            case Config("API_LIST_ACTION"):
                return "DataInProjectList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("DataInProjectView", $parm);
        } else {
            $url = $this->keyUrl("DataInProjectView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "DataInProjectAdd?" . $parm;
        } else {
            $url = "DataInProjectAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DataInProjectEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DataInProjectList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DataInProjectAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DataInProjectList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("DataInProjectDelete");
        }
    }
