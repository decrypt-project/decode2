 ...
 * Page class
 */
class ImagesDelete extends Images
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ImagesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ImagesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ImagesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ImagesList"); // Return to list
                return;
            }
        }
