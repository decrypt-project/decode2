 ...
 * Page class
 */
class FileInProjectAdd extends FileInProject
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FileInProjectAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "FileInProjectAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "FileInProjectView") {
