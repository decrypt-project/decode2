...
/**
 * Table class for Documents by century
 */
class DocumentsByCentury extends CrosstabTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->ReportSourceTable = 'recordstat'; // Report source table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->id->SourceTableVar = 'recordstat';
        ...
        $this->name->SourceTableVar = 'recordstat';
        ...
        $this->type->SourceTableVar = 'recordstat';
        $this->Fields['type'] = &$this->type;

        // origin_region
        $this->origin_region = new ReportField(
            $this, // Table
        ...
        $this->origin_region->GroupingFieldId = 2;
        ...
        $this->origin_region->SourceTableVar = 'recordstat';
        $this->Fields['origin_region'] = &$this->origin_region;

        // cleartext_lang
        $this->cleartext_lang = new ReportField(
            $this, // Table
        ...
        $this->cleartext_lang->SourceTableVar = 'recordstat';
        $this->Fields['cleartext_lang'] = &$this->cleartext_lang;

        // plaintext_lang
        $this->plaintext_lang = new ReportField(
            $this, // Table
        ...
        $this->plaintext_lang->SourceTableVar = 'recordstat';
        $this->Fields['plaintext_lang'] = &$this->plaintext_lang;

        // century
        $this->century = new ReportField(
            $this, // Table
            'x_century', // Variable name
            'century', // Name
            '`century`', // Expression
            '`century`', // Basic search expression
            200, // Type
            7, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`century`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->century->InputTextType = "text";
        $this->century->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->century->SourceTableVar = 'recordstat';
        $this->Fields['century'] = &$this->century;

        // Documents by century
        $this->Documentsbycentury = new DbChart($this, 'Documentsbycentury', 'Documents by century', 'century', 'id', 1004, '', 0, 'COUNT', 600, 500);
        $this->Documentsbycentury->Position = 4;
        $this->Documentsbycentury->PageBreakType = "before";
        $this->Documentsbycentury->YAxisFormat = [""];
        $this->Documentsbycentury->YFieldFormat = [""];
        $this->Documentsbycentury->SortType = 0;
        $this->Documentsbycentury->SortSequence = "";
        $this->Documentsbycentury->SqlSelect = $this->getQueryBuilder()->select("`century`", "''", "COUNT(`id`)");
        $this->Documentsbycentury->SqlGroupBy = "`century`";
        $this->Documentsbycentury->SqlOrderBy = "";
        $this->Documentsbycentury->SeriesDateType = "";
        $this->Documentsbycentury->ID = "Documents_by_century_Documentsbycentury"; // Chart ID
        $this->Documentsbycentury->setParameters([
            ["type", "1004"],
            ["seriestype", "0"]
        ]); // Chart type / Chart series type
        $this->Documentsbycentury->setParameters([
            ["caption", $this->Documentsbycentury->caption()],
            ["xaxisname", $this->Documentsbycentury->xAxisName()]
        ]); // Chart caption / X axis name
        $this->Documentsbycentury->setParameter("yaxisname", $this->Documentsbycentury->yAxisName()); // Y axis name
        $this->Documentsbycentury->setParameters([
            ["shownames", "1"],
            ["showvalues", "1"],
            ["showhovercap", "1"]
        ]); // Show names / Show values / Show hover
        $this->Documentsbycentury->setParameter("alpha", "50"); // Chart alpha
        $this->Documentsbycentury->setParameter("colorpalette", "#5899DA,#E8743B,#19A979,#ED4A7B,#945ECF,#13A4B4,#525DF4,#BF399E,#6C8893,#EE6868,#2F6497"); // Chart color palette
        $this->Charts[$this->Documentsbycentury->ID] = &$this->Documentsbycentury;
    ...
    {
        return ($this->columnField != "") ? $this->columnField : "`century`";
    }
    ...
    {
        return $this->sqlDistinctSelect ?? $this->getQueryBuilder()->select("`century`")->distinct();
    }
    ...
    {
        return ($this->sqlDistinctOrderBy != "") ? $this->sqlDistinctOrderBy : "`century` ASC";
    }
...
*/
        ...
        $groupCount = 2;
        $this->SummaryFields[0] = new SummaryField('x_id', 'id', '`id`', 'COUNT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "recordstat";
    }
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("`type`, `origin_region`");
    }
    ...
    {
        return ($this->SqlGroupBy != "") ? $this->SqlGroupBy : "`type`, `origin_region`";
    }
    ...
    {
        return "DocumentsByCenturyCrosstab";
    }
