 ...
 * Page class
 */
class RecordInProjectAdd extends RecordInProject
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RecordInProjectAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "RecordInProjectAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("RecordInProjectList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "RecordInProjectList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "RecordInProjectView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "RecordInProjectList") {
                            ...
                            $returnUrl = "RecordInProjectList"; // Return list page content
                        }
                    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("RecordInProjectList"), "", $this->TableVar, true);
