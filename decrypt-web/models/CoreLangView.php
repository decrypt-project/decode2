 ...
 * Page class
 */
class CoreLangView extends CoreLang
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CoreLangView";
    ...
    // CSS class/style
    public $CurrentPageName = "CoreLangView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "CoreLangList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "CoreLangList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
