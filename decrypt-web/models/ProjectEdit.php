 ...
 * Page class
 */
class ProjectEdit extends Project
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProjectEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ProjectEdit";
    ...
    protected function validateForm()
    {
        ...
        if (in_array("record_in_project", $detailTblVar) && $detailPage->DetailEdit) {
            $detailPage->run();
            $validateForm = $validateForm && $detailPage->validateGridForm();
        }
        $detailPage = Container("FileInProjectGrid");
        if (in_array("file_in_project", $detailTblVar) && $detailPage->DetailEdit) {
            $detailPage->run();
            $validateForm = $validateForm && $detailPage->validateGridForm();
        }
        $detailPage = Container("DataInProjectGrid");
        if (in_array("data_in_project", $detailTblVar) && $detailPage->DetailEdit) {
            $detailPage->run();
            $validateForm = $validateForm && $detailPage->validateGridForm();
        }
    ...
    protected function editRow()
    {
        ...
        // has_access
        $this->has_access->setDbValueDef($rsnew, $this->has_access->CurrentValue, $this->has_access->ReadOnly);
        ...
        if ($updateRow) {
            ...
            $detailTblVar = explode(",", $this->getCurrentDetailTable());
            $detailPage = Container("RecordInProjectGrid");
            if (in_array("record_in_project", $detailTblVar) && $detailPage->DetailEdit && $editRow) {
                $Security->loadCurrentUserLevel($this->ProjectID . "record_in_project"); // Load user level of detail table
                $editRow = $detailPage->gridUpdate();
                $Security->loadCurrentUserLevel($this->ProjectID . $this->TableName); // Restore user level of master table
            }
            $detailPage = Container("FileInProjectGrid");
            if (in_array("file_in_project", $detailTblVar) && $detailPage->DetailEdit && $editRow) {
                $Security->loadCurrentUserLevel($this->ProjectID . "file_in_project"); // Load user level of detail table
                $editRow = $detailPage->gridUpdate();
                $Security->loadCurrentUserLevel($this->ProjectID . $this->TableName); // Restore user level of master table
            }
            $detailPage = Container("DataInProjectGrid");
            if (in_array("data_in_project", $detailTblVar) && $detailPage->DetailEdit && $editRow) {
