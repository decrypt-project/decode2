...
class DocumentsSearch extends Documents
{
    ...
    // Page object name
    public $PageObjName = "DocumentsSearch";
    ...
    // CSS class/style
    public $CurrentPageName = "DocumentsSearch";
    ...
    public function setVisibility()
    {
        ...
        $this->public_->Visible = false;
        $this->record_id->Visible = false;
        $this->uploader_id->Visible = false;
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->_title->setupEditAttributes();
            if (!$this->_title->Raw) {
                $this->_title->AdvancedSearch->SearchValue2 = HtmlDecode($this->_title->AdvancedSearch->SearchValue2);
            }
            $this->_title->EditValue2 = HtmlEncode($this->_title->AdvancedSearch->SearchValue2);
            $this->_title->PlaceHolder = RemoveHtml($this->_title->caption());
