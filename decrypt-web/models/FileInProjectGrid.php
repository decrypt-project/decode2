 ...
 * Page class
 */
class FileInProjectGrid extends FileInProject
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FileInProjectGrid";
    ...
    public $FormName = "ffile_in_projectgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "FileInProjectGrid";
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_filename") && $CurrentForm->hasValue("o_filename") && $this->filename->CurrentValue != $this->filename->DefaultValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_type") && $CurrentForm->hasValue("o_type") && $this->type->CurrentValue != $this->type->DefaultValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_filesize") && $CurrentForm->hasValue("o_filesize") && $this->filesize->CurrentValue != $this->filesize->DefaultValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_creation_date") && $CurrentForm->hasValue("o_creation_date") && $this->creation_date->CurrentValue != $this->creation_date->DefaultValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_last_updated") && $CurrentForm->hasValue("o_last_updated") && $this->last_updated->CurrentValue != $this->last_updated->DefaultValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_locked_by") && $CurrentForm->hasValue("o_locked_by") && $this->locked_by->CurrentValue != $this->locked_by->DefaultValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_lock_date") && $CurrentForm->hasValue("o_lock_date") && $this->lock_date->CurrentValue != $this->lock_date->DefaultValue) {
            return false;
        }
        return true;
    }
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_filename")) {
        ...
        if ($CurrentForm->hasValue("o_filesize")) {
            $this->filesize->setOldValue($CurrentForm->getValue("o_filesize"));
        }
        ...
        if ($CurrentForm->hasValue("o_creation_date")) {
            $this->creation_date->setOldValue($CurrentForm->getValue("o_creation_date"));
        }
        ...
        if ($CurrentForm->hasValue("o_last_updated")) {
            $this->last_updated->setOldValue($CurrentForm->getValue("o_last_updated"));
        }
        ...
        if ($CurrentForm->hasValue("o_locked_by")) {
            $this->locked_by->setOldValue($CurrentForm->getValue("o_locked_by"));
        }
        ...
        if ($CurrentForm->hasValue("o_lock_date")) {
            $this->lock_date->setOldValue($CurrentForm->getValue("o_lock_date"));
        }
    }
    ...
    protected function editRow()
    {
        ...
        // filesize
        $this->filesize->setDbValueDef($rsnew, $this->filesize->CurrentValue, $this->filesize->ReadOnly);
    ...
    protected function addRow($rsold = null)
    {
        ...
        // filesize
        $this->filesize->setDbValueDef($rsnew, $this->filesize->CurrentValue, false);

        // creation_date
        $this->creation_date->setDbValueDef($rsnew, UnFormatDateTime($this->creation_date->CurrentValue, $this->creation_date->formatPattern()), false);

        // last_updated
        $this->last_updated->setDbValueDef($rsnew, UnFormatDateTime($this->last_updated->CurrentValue, $this->last_updated->formatPattern()), false);

        // locked_by
        $this->locked_by->setDbValueDef($rsnew, $this->locked_by->CurrentValue, false);

        // lock_date
        $this->lock_date->setDbValueDef($rsnew, UnFormatDateTime($this->lock_date->CurrentValue, $this->lock_date->formatPattern()), false);
        ...
        // Check referential integrity for master table 'file_in_project'
