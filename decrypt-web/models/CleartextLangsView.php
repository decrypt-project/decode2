 ...
 * Page class
 */
class CleartextLangsView extends CleartextLangs
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CleartextLangsView";
    ...
    // CSS class/style
    public $CurrentPageName = "CleartextLangsView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "CleartextLangsList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "CleartextLangsList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
