 ...
 * Page class
 */
class CoreContentView extends CoreContent
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CoreContentView";
    ...
    // CSS class/style
    public $CurrentPageName = "CoreContentView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "CoreContentList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "CoreContentList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
