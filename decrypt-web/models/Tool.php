...
/**
 * Table class for tool
 */
class Tool extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function getDetailUrl()
    {
        // Detail url
        $detailUrl = "";
        if ($this->getCurrentDetailTable() == "toolconfigkey") {
            $detailUrl = Container("toolconfigkey")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "tool";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ToolList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ToolView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ToolEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ToolAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ToolView", $parm);
        } else {
            $url = $this->keyUrl("ToolView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ToolEdit", $parm);
        } else {
            $url = $this->keyUrl("ToolEdit", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ToolList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ToolAdd", $parm);
        } else {
            $url = $this->keyUrl("ToolAdd", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ToolList", "action=copy");
        return $this->addMasterUrl($url);
    }
