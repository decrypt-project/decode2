...
class Documents extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // filetype
        $this->filetype = new DbField(
            $this, // Table
            'x_filetype', // Variable name
            'filetype', // Name
            '`filetype`', // Expression
            '`filetype`', // Basic search expression
            200, // Type
            64, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`filetype`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->filetype->InputTextType = "text";
        $this->filetype->Nullable = false; // NOT NULL field
        $this->filetype->Required = true; // Required field
        $this->filetype->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        $this->Fields['filetype'] = &$this->filetype;
        ...
        $this->size->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        ...
        $this->upload_date = new DbField(
            ...
            CastDateFieldForLike("`upload_date`", 0, "DB"), // Basic search expression
            135, // Type
            19, // Size
            0, // Date/Time format
            false, // Is upload field
        ...
        $this->upload_date->addMethod("getDefault", fn() => date('Y-m-d H:i:s'));
        $this->upload_date->InputTextType = "text";
        $this->upload_date->Nullable = false; // NOT NULL field
        $this->upload_date->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        $this->upload_date->SearchOperators = ["=", "<>"];
        ...
        $this->category->Lookup = new Lookup($this->category, 'documents', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
        $this->category->OptionCount = 9;
        $this->category->SearchOperators = ["=", "<>"];
        $this->Fields['category'] = &$this->category;

        // order_
        $this->order_ = new DbField(
            $this, // Table
            'x_order_', // Variable name
            'order_', // Name
            '`order_`', // Expression
            '`order_`', // Basic search expression
            3, // Type
            11, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`order_`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->order_->InputTextType = "text";
        $this->order_->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->order_->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['order_'] = &$this->order_;

        // public_
        $this->public_ = new DbField(
            $this, // Table
            'x_public_', // Variable name
            'public_', // Name
            '`public_`', // Expression
            '`public_`', // Basic search expression
            129, // Type
            5, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`public_`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->public_->addMethod("getDefault", fn() => "True");
        $this->public_->InputTextType = "text";
        $this->public_->Nullable = false; // NOT NULL field
        $this->public_->Lookup = new Lookup($this->public_, 'documents', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
        $this->public_->OptionCount = 2;
        $this->public_->SearchOperators = ["=", "<>"];
        $this->Fields['public_'] = &$this->public_;

        // record_id
        $this->record_id = new DbField(
            $this, // Table
            'x_record_id', // Variable name
            'record_id', // Name
            '`record_id`', // Expression
            '`record_id`', // Basic search expression
            3, // Type
            11, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`record_id`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->record_id->addMethod("getLinkPrefix", fn() => "/decrypt-web/RecordsView/");
        $this->record_id->InputTextType = "text";
        $this->record_id->IsForeignKey = true; // Foreign key field
        $this->record_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->record_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['record_id'] = &$this->record_id;

        // uploader_id
        $this->uploader_id = new DbField(
            $this, // Table
            'x_uploader_id', // Variable name
            'uploader_id', // Name
            '`uploader_id`', // Expression
            '`uploader_id`', // Basic search expression
            3, // Type
            11, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`uploader_id`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->uploader_id->addMethod("getDefault", fn() => myCurrentUserID());
        $this->uploader_id->InputTextType = "text";
        $this->uploader_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->uploader_id->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
        $this->Fields['uploader_id'] = &$this->uploader_id;

        // path
        $this->path = new DbField(
            $this, // Table
            'x_path', // Variable name
            'path', // Name
            '`path`', // Expression
            '`path`', // Basic search expression
            201, // Type
            256, // Size
            -1, // Date/Time format
            true, // Is upload field
            '`path`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->path->InputTextType = "text";
        $this->path->Required = true; // Required field
        $this->path->SearchOperators = ["=", "<>", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
    ...
    public function getMasterFilterFromSession()
    {
        ...
        if ($this->getCurrentMasterTable() == "records") {
            ...
            if ($this->record_id->getSessionValue() != "") {
                $masterFilter .= "" . GetKeyFilter($masterTable->id, $this->record_id->getSessionValue(), $masterTable->id->DataType, $masterTable->Dbid);
            } else {
                return "";
            }
        }
    ...
    public function getDetailFilterFromSession()
    {
        ...
        if ($this->getCurrentMasterTable() == "records") {
            $masterTable = Container("records");
            if ($this->record_id->getSessionValue() != "") {
                $detailFilter .= "" . GetKeyFilter($this->record_id, $this->record_id->getSessionValue(), $masterTable->id->DataType, $this->Dbid);
            } else {
                return "";
            }
        }
    ...
    public function getMasterFilter($masterTable, $keys)
    {
        ...
        switch ($masterTable->TableVar) {
            case "records":
                ...
                if ($validKeys) {
                    return GetKeyFilter($masterTable->id, $keys["record_id"], $this->record_id->DataType, $this->Dbid);
                }
                break;
        }
    ...
    public function getDetailFilter($masterTable)
    {
        switch ($masterTable->TableVar) {
            case "records":
                return GetKeyFilter($this->record_id, $masterTable->id->DbValue, $masterTable->id->DataType, $masterTable->Dbid);
        }
        return "";
    }
    ...
    public function applyUserIDFilters($filter, $id = "")
    {
        ...
        if ($Security->currentUserID() != "" && !$Security->isAdmin()) { // Non system admin
            if ($this->getCurrentMasterTable() == "records" || $this->getCurrentMasterTable() == "") {
                $filter = $this->addDetailUserIDFilter($filter, "records"); // Add detail User ID filter
            }
        }
        return $filter;
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->filetype->DbValue = $row['filetype'];
        $this->size->DbValue = $row['size'];
        $this->upload_date->DbValue = $row['upload_date'];
        $this->category->DbValue = $row['category'];
        $this->order_->DbValue = $row['order_'];
        $this->public_->DbValue = $row['public_'];
        $this->record_id->DbValue = $row['record_id'];
        $this->uploader_id->DbValue = $row['uploader_id'];
    ...
    {
        if ($this->getCurrentMasterTable() == "records" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            $url .= (ContainsString($url, "?") ? "&" : "?") . Config("TABLE_SHOW_MASTER") . "=" . $this->getCurrentMasterTable();
            $url .= "&" . GetForeignKeyUrl("fk_id", $this->record_id->getSessionValue()); // Use Session Value
        }
        return $url;
    }
    ...
    public function renderListRow()
    {
        ...
        // order_
        $this->order_->HrefValue = "";
        $this->order_->TooltipValue = "";

        // public_
        $this->public_->HrefValue = "";
        $this->public_->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        if (!$this->filetype->Raw) {
            $this->filetype->CurrentValue = HtmlDecode($this->filetype->CurrentValue);
        }
        $this->filetype->EditValue = $this->filetype->CurrentValue;
        ...
        $this->upload_date->CurrentValue = FormatDateTime($this->upload_date->CurrentValue, $this->upload_date->formatPattern());
        ...
        // order_
        $this->order_->setupEditAttributes();
        $this->order_->EditValue = $this->order_->CurrentValue;
        $this->order_->PlaceHolder = RemoveHtml($this->order_->caption());
        if (strval($this->order_->EditValue) != "" && is_numeric($this->order_->EditValue)) {
            $this->order_->EditValue = FormatNumber($this->order_->EditValue, null);
        }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->filetype);
                    $doc->exportCaption($this->size);
                    $doc->exportCaption($this->upload_date);
                    $doc->exportCaption($this->category);
                    $doc->exportCaption($this->order_);
                    $doc->exportCaption($this->public_);
                    $doc->exportCaption($this->record_id);
                    $doc->exportCaption($this->uploader_id);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->filetype);
                        $doc->exportField($this->size);
                        $doc->exportField($this->upload_date);
                        $doc->exportField($this->category);
                        $doc->exportField($this->order_);
                        $doc->exportField($this->public_);
                        $doc->exportField($this->record_id);
                        $doc->exportField($this->uploader_id);
    ...
    if (!empty($rsnew['path'])) {
    		$origname = html_entity_decode($rsnew['path']);
    		$extA = explode('.', $origname);
    		$ext = $extA[count($extA)-1];
    		$rsnew['filename'] = $origname;
    		$rsnew['path'] = "DOC_" . $rsnew['record_id'] . "_" . date('Y-M-d-H-i-s') . "_" . rand(10000,99999). '.' . $ext;
    	}
    	return TRUE;
    }
