...
/**
 * Table class for recordstat
 */
class Recordstat extends DbTable
{
    protected $SqlFrom = "";
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->century->DbValue = $row['century'];
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("RecordstatList");
    }
    ...
    {
        global $Language;
        if ($pageName == "RecordstatView") {
            return $Language->phrase("View");
        } elseif ($pageName == "RecordstatEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "RecordstatAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "RecordstatAdd";
            case Config("API_EDIT_ACTION"):
                return "RecordstatEdit";
            case Config("API_DELETE_ACTION"):
                return "RecordstatDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("RecordstatView", $parm);
        } else {
            $url = $this->keyUrl("RecordstatView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("RecordstatEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("RecordstatList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("RecordstatAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("RecordstatList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("RecordstatDelete");
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        // century
        $this->century->setupEditAttributes();
        if (!$this->century->Raw) {
            $this->century->CurrentValue = HtmlDecode($this->century->CurrentValue);
        }
        $this->century->EditValue = $this->century->CurrentValue;
        $this->century->PlaceHolder = RemoveHtml($this->century->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->century);
                } else {
                    $doc->exportCaption($this->id);
                    $doc->exportCaption($this->name);
                    $doc->exportCaption($this->type);
