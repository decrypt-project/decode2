...
/**
 * Table class for recordview
 */
class Recordview extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->id->addMethod("getLinkPrefix", fn() => "https://de-crypt.org/decrypt-web/RecordsView/");
        ...
        $this->owner_id->Lookup = new Lookup($this->owner_id, 'users', false, 'id', ["username","","",""], '', '', [], [], [], [], [], [], '', '', "`username`");
        ...
        $this->record_group_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        ...
        $this->creator_id->Lookup = new Lookup($this->creator_id, 'users', false, 'id', ["username","","",""], '', '', [], [], [], [], [], [], '', '', "`username`");
        $this->creator_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->creator_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        ...
        $this->inline_cleartext->Lookup = new Lookup($this->inline_cleartext, 'recordview', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
        ...
        $this->inline_plaintext->Lookup = new Lookup($this->inline_plaintext, 'recordview', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
        ...
        $this->private_ciphertext->Lookup = new Lookup($this->private_ciphertext, 'recordview', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
        ...
        $this->cipher_types->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        ...
        $this->symbol_sets->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        ...
        $this->record_type->Lookup = new Lookup($this->record_type, 'recordview', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
        ...
        $this->access_mode->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['access_mode'] = &$this->access_mode;

        // transc_files
        $this->transc_files = new DbField(
            $this, // Table
            'x_transc_files', // Variable name
            'transc_files', // Name
            '`transc_files`', // Expression
            '`transc_files`', // Basic search expression
            201, // Type
            16777215, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`transc_files`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->transc_files->InputTextType = "text";
        $this->transc_files->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['transc_files'] = &$this->transc_files;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "recordview";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->transc_files->DbValue = $row['transc_files'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("RecordviewList");
    }
    ...
    {
        global $Language;
        if ($pageName == "RecordviewView") {
            return $Language->phrase("View");
        } elseif ($pageName == "RecordviewEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "RecordviewAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "RecordviewAdd";
            case Config("API_EDIT_ACTION"):
                return "RecordviewEdit";
            case Config("API_DELETE_ACTION"):
                return "RecordviewDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("RecordviewView", $parm);
        } else {
            $url = $this->keyUrl("RecordviewView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("RecordviewEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("RecordviewList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("RecordviewAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("RecordviewList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("RecordviewDelete");
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->record_group_id->EditValue = $this->record_group_id->CurrentValue;
        $this->record_group_id->PlaceHolder = RemoveHtml($this->record_group_id->caption());
        if (strval($this->record_group_id->EditValue) != "" && is_numeric($this->record_group_id->EditValue)) {
            $this->record_group_id->EditValue = FormatNumber($this->record_group_id->EditValue, null);
        }
        ...
        $this->creator_id->EditValue = $this->creator_id->CurrentValue;
        ...
        // cipher_types
        $this->cipher_types->setupEditAttributes();
        if (!$this->cipher_types->Raw) {
            $this->cipher_types->CurrentValue = HtmlDecode($this->cipher_types->CurrentValue);
        }
        $this->cipher_types->EditValue = $this->cipher_types->CurrentValue;
        $this->cipher_types->PlaceHolder = RemoveHtml($this->cipher_types->caption());

        // symbol_sets
        $this->symbol_sets->setupEditAttributes();
        if (!$this->symbol_sets->Raw) {
            $this->symbol_sets->CurrentValue = HtmlDecode($this->symbol_sets->CurrentValue);
        }
        $this->symbol_sets->EditValue = $this->symbol_sets->CurrentValue;
        ...
        // record_type
        $this->record_type->EditValue = $this->record_type->options(false);
        $this->record_type->PlaceHolder = RemoveHtml($this->record_type->caption());

        // access_mode
        $this->access_mode->setupEditAttributes();
        $this->access_mode->EditValue = $this->access_mode->CurrentValue;
        $this->access_mode->PlaceHolder = RemoveHtml($this->access_mode->caption());
        if (strval($this->access_mode->EditValue) != "" && is_numeric($this->access_mode->EditValue)) {
            $this->access_mode->EditValue = FormatNumber($this->access_mode->EditValue, null);
        }

        // transc_files
        $this->transc_files->setupEditAttributes();
        $this->transc_files->EditValue = $this->transc_files->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->additional_information);
                    ...
                    $doc->exportCaption($this->transc_files);
                    ...
                    $doc->exportCaption($this->owner_id);
                    $doc->exportCaption($this->owner);
                    $doc->exportCaption($this->record_group_id);
                    $doc->exportCaption($this->start_year);
                    $doc->exportCaption($this->start_month);
                    $doc->exportCaption($this->start_day);
                    $doc->exportCaption($this->end_year);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->additional_information);
                        ...
                        $doc->exportField($this->transc_files);
                        ...
                        $doc->exportField($this->owner_id);
                        $doc->exportField($this->owner);
                        $doc->exportField($this->record_group_id);
                        $doc->exportField($this->start_year);
                        $doc->exportField($this->start_month);
                        $doc->exportField($this->start_day);
                        $doc->exportField($this->end_year);
