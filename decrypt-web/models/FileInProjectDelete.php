 ...
 * Page class
 */
class FileInProjectDelete extends FileInProject
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FileInProjectDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "FileInProjectDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("FileInProjectList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("FileInProjectList"); // Return to list
                return;
            }
        }
