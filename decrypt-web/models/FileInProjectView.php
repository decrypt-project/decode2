 ...
 * Page class
 */
class FileInProjectView extends FileInProject
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FileInProjectView";
    ...
    // CSS class/style
    public $CurrentPageName = "FileInProjectView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "FileInProjectList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "FileInProjectList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
