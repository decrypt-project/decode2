...
class UsersList extends Users
{
    ...
    public function setVisibility()
    {
        ...
        $this->terms_of_use->Visible = false;
        $this->updated_at->Visible = false;
        $this->superuser->Visible = false;
        $this->all_access->Visible = false;
        $this->name->setVisibility();
        $this->affiliation->Visible = false;
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->memo->AdvancedSearch->toJson(), ","); // Field memo
        $filterList = Concat($filterList, $this->terms_of_use->AdvancedSearch->toJson(), ","); // Field terms_of_use
        $filterList = Concat($filterList, $this->updated_at->AdvancedSearch->toJson(), ","); // Field updated_at
        $filterList = Concat($filterList, $this->all_access->AdvancedSearch->toJson(), ","); // Field all_access
        $filterList = Concat($filterList, $this->name->AdvancedSearch->toJson(), ","); // Field name
        $filterList = Concat($filterList, $this->affiliation->AdvancedSearch->toJson(), ","); // Field affiliation
        $filterList = Concat($filterList, $this->background->AdvancedSearch->toJson(), ","); // Field background
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function restoreFilterList()
    {
        ...
        // Field memo
        $this->memo->AdvancedSearch->SearchValue = @$filter["x_memo"];
        $this->memo->AdvancedSearch->SearchOperator = @$filter["z_memo"];
        $this->memo->AdvancedSearch->SearchCondition = @$filter["v_memo"];
        $this->memo->AdvancedSearch->SearchValue2 = @$filter["y_memo"];
        $this->memo->AdvancedSearch->SearchOperator2 = @$filter["w_memo"];
        $this->memo->AdvancedSearch->save();

        // Field terms_of_use
        $this->terms_of_use->AdvancedSearch->SearchValue = @$filter["x_terms_of_use"];
        $this->terms_of_use->AdvancedSearch->SearchOperator = @$filter["z_terms_of_use"];
        $this->terms_of_use->AdvancedSearch->SearchCondition = @$filter["v_terms_of_use"];
        $this->terms_of_use->AdvancedSearch->SearchValue2 = @$filter["y_terms_of_use"];
        $this->terms_of_use->AdvancedSearch->SearchOperator2 = @$filter["w_terms_of_use"];
        $this->terms_of_use->AdvancedSearch->save();
        ...
        // Field all_access
        $this->all_access->AdvancedSearch->SearchValue = @$filter["x_all_access"];
        $this->all_access->AdvancedSearch->SearchOperator = @$filter["z_all_access"];
        $this->all_access->AdvancedSearch->SearchCondition = @$filter["v_all_access"];
        $this->all_access->AdvancedSearch->SearchValue2 = @$filter["y_all_access"];
        $this->all_access->AdvancedSearch->SearchOperator2 = @$filter["w_all_access"];
        $this->all_access->AdvancedSearch->save();
        ...
        // Field affiliation
        $this->affiliation->AdvancedSearch->SearchValue = @$filter["x_affiliation"];
        $this->affiliation->AdvancedSearch->SearchOperator = @$filter["z_affiliation"];
        $this->affiliation->AdvancedSearch->SearchCondition = @$filter["v_affiliation"];
        $this->affiliation->AdvancedSearch->SearchValue2 = @$filter["y_affiliation"];
        $this->affiliation->AdvancedSearch->SearchOperator2 = @$filter["w_affiliation"];
        $this->affiliation->AdvancedSearch->save();

        // Field background
        $this->background->AdvancedSearch->SearchValue = @$filter["x_background"];
        $this->background->AdvancedSearch->SearchOperator = @$filter["z_background"];
        $this->background->AdvancedSearch->SearchCondition = @$filter["v_background"];
        $this->background->AdvancedSearch->SearchValue2 = @$filter["y_background"];
        $this->background->AdvancedSearch->SearchOperator2 = @$filter["w_background"];
        $this->background->AdvancedSearch->save();
    ...
    public function basicSearchWhere($default = false)
    {
        ...
        $searchFlds[] = &$this->memo;
        $searchFlds[] = &$this->name;
        $searchFlds[] = &$this->affiliation;
        $searchFlds[] = &$this->background;
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->superuser->setSort("");
                $this->all_access->setSort("");
                $this->name->setSort("");
                $this->affiliation->setSort("");
                $this->background->setSort("");
            }
