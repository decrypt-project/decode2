 ...
 * Page class
 */
class TranscriptionsGrid extends Transcriptions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TranscriptionsGrid";
    ...
    public $FormName = "ftranscriptionsgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "TranscriptionsGrid";
    ...
    {
        global $CurrentForm;
        if ($CurrentForm->hasValue("x_image_id") && $CurrentForm->hasValue("o_image_id") && $this->image_id->CurrentValue != $this->image_id->DefaultValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_description") && $CurrentForm->hasValue("o_description") && $this->description->CurrentValue != $this->description->DefaultValue) {
            return false;
        }
        return true;
    }
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->image_id->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->image_id->setFormValue($val, true, $validate);
            }
        }
        if ($CurrentForm->hasValue("o_image_id")) {
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            // image_id
            $this->image_id->setupEditAttributes();
            if ($this->image_id->getSessionValue() != "") {
                $this->image_id->CurrentValue = GetForeignKeyValue($this->image_id->getSessionValue());
                ...
                if (strval($this->image_id->EditValue) != "" && is_numeric($this->image_id->EditValue)) {
                    $this->image_id->EditValue = FormatNumber($this->image_id->EditValue, null);
                }
            }
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
        if ($this->image_id->Visible && $this->image_id->Required) {
            if (!$this->image_id->IsDetailKey && EmptyValue($this->image_id->FormValue)) {
                $this->image_id->addErrorMessage(str_replace("%s", $this->image_id->caption(), $this->image_id->RequiredErrorMessage));
            }
        }
        if (!CheckInteger($this->image_id->FormValue)) {
            $this->image_id->addErrorMessage($this->image_id->getErrorMessage(false));
        }
    ...
    protected function editRow()
    {
        ...
        $this->image_id->setDbValueDef($rsnew, $this->image_id->CurrentValue, $this->image_id->ReadOnly);
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "images") {
            $this->image_id->Visible = true; // Need to insert foreign key
        ...
        // image_id
        $this->image_id->setDbValueDef($rsnew, $this->image_id->CurrentValue, false);
