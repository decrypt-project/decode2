 ...
 * Page class
 */
class RecordInProjectDelete extends RecordInProject
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RecordInProjectDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "RecordInProjectDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("RecordInProjectList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("RecordInProjectList"); // Return to list
                return;
            }
        }
