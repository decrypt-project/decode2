...
/**
 * Table class for file_in_project
 */
class FileInProject extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "file_in_project";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->filename->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        ...
        $this->type->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        ...
        $this->filetype->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['filetype'] = &$this->filetype;

        // filesize
        $this->filesize = new DbField(
            $this, // Table
            'x_filesize', // Variable name
            'filesize', // Name
            '`filesize`', // Expression
            '`filesize`', // Basic search expression
            3, // Type
            11, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`filesize`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->filesize->InputTextType = "text";
        $this->filesize->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->filesize->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        ...
        $this->last_updated = new DbField(
            ...
            CastDateFieldForLike("`last_updated`", 0, "DB"), // Basic search expression
            135, // Type
            19, // Size
            0, // Date/Time format
            false, // Is upload field
        ...
        $this->lock_date = new DbField(
            ...
            CastDateFieldForLike("`lock_date`", 0, "DB"), // Basic search expression
            135, // Type
            19, // Size
            0, // Date/Time format
            false, // Is upload field
        ...
        $this->lock_date->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "file_in_project";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("FileInProjectList");
    }
    ...
    {
        global $Language;
        if ($pageName == "FileInProjectView") {
            return $Language->phrase("View");
        } elseif ($pageName == "FileInProjectEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "FileInProjectAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "FileInProjectView";
            case Config("API_ADD_ACTION"):
                return "FileInProjectAdd";
            case Config("API_EDIT_ACTION"):
                return "FileInProjectEdit";
            case Config("API_DELETE_ACTION"):
                return "FileInProjectDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("FileInProjectView", $parm);
        } else {
            $url = $this->keyUrl("FileInProjectView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "FileInProjectAdd?" . $parm;
        } else {
            $url = "FileInProjectAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FileInProjectEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FileInProjectList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FileInProjectAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("FileInProjectList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("FileInProjectDelete");
        }
    }
