 ...
 * Page class
 */
class ProjectDelete extends Project
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProjectDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ProjectDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ProjectList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ProjectList"); // Return to list
                return;
            }
        }
