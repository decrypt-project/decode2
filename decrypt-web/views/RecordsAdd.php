...
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        ...
        .setFields([
            ...
            ["owner_id", [fields.owner_id.visible && fields.owner_id.required ? ew.Validators.required(fields.owner_id.caption) : null], fields.owner_id.isInvalid],
...
$Page->showMessage();
?>
<form name="frecordsadd" id="frecordsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<script>
loadjs.ready("frecordsadd", function() {
    frecordsadd.createAutoSuggest(Object.assign({"id":"x_name","forceSelect":false}, { lookupAllDisplayFields: <?= $Page->name->Lookup->LookupAllDisplayFields ? "true" : "false" ?> }, ew.vars.tables.records.fields.name.autoSuggestOptions));
});
</script>
...
<?php } ?>
    <span id="el_records_owner_id">
    <input type="hidden" data-table="records" data-field="x_owner_id" data-hidden="1" name="x_owner_id" id="x_owner_id" value="<?= HtmlEncode($Page->owner_id->CurrentValue) ?>">
    </span>
...
<script>
loadjs.ready("frecordsadd", function() {
    frecordsadd.createAutoSuggest(Object.assign({"id":"x_current_country","forceSelect":false}, { lookupAllDisplayFields: <?= $Page->current_country->Lookup->LookupAllDisplayFields ? "true" : "false" ?> }, ew.vars.tables.records.fields.current_country.autoSuggestOptions));
});
</script>
...
<script>
loadjs.ready("frecordsadd", function() {
    frecordsadd.createAutoSuggest(Object.assign({"id":"x_current_city","forceSelect":false}, { lookupAllDisplayFields: <?= $Page->current_city->Lookup->LookupAllDisplayFields ? "true" : "false" ?> }, ew.vars.tables.records.fields.current_city.autoSuggestOptions));
});
</script>
...
<script>
loadjs.ready("frecordsadd", function() {
    frecordsadd.createAutoSuggest(Object.assign({"id":"x_current_holder","forceSelect":false}, { lookupAllDisplayFields: <?= $Page->current_holder->Lookup->LookupAllDisplayFields ? "true" : "false" ?> }, ew.vars.tables.records.fields.current_holder.autoSuggestOptions));
});
</script>
...
<script>
loadjs.ready("frecordsadd", function() {
    frecordsadd.createAutoSuggest(Object.assign({"id":"x_author","forceSelect":false}, { lookupAllDisplayFields: <?= $Page->author->Lookup->LookupAllDisplayFields ? "true" : "false" ?> }, ew.vars.tables.records.fields.author.autoSuggestOptions));
});
</script>
...
<script>
loadjs.ready("frecordsadd", function() {
    frecordsadd.createAutoSuggest(Object.assign({"id":"x_sender","forceSelect":false}, { lookupAllDisplayFields: <?= $Page->sender->Lookup->LookupAllDisplayFields ? "true" : "false" ?> }, ew.vars.tables.records.fields.sender.autoSuggestOptions));
});
</script>
...
<script>
loadjs.ready("frecordsadd", function() {
    frecordsadd.createAutoSuggest(Object.assign({"id":"x_receiver","forceSelect":false}, { lookupAllDisplayFields: <?= $Page->receiver->Lookup->LookupAllDisplayFields ? "true" : "false" ?> }, ew.vars.tables.records.fields.receiver.autoSuggestOptions));
});
</script>
...
<script>
loadjs.ready("frecordsadd", function() {
    frecordsadd.createAutoSuggest(Object.assign({"id":"x_origin_region","forceSelect":false}, { lookupAllDisplayFields: <?= $Page->origin_region->Lookup->LookupAllDisplayFields ? "true" : "false" ?> }, ew.vars.tables.records.fields.origin_region.autoSuggestOptions));
});
</script>
...
<script>
loadjs.ready("frecordsadd", function() {
    frecordsadd.createAutoSuggest(Object.assign({"id":"x_origin_city","forceSelect":false}, { lookupAllDisplayFields: <?= $Page->origin_city->Lookup->LookupAllDisplayFields ? "true" : "false" ?> }, ew.vars.tables.records.fields.origin_city.autoSuggestOptions));
});
</script>
...
<span id="el_records_record_type">
    <select
        ...
        data-select2-id="frecordsadd_x_record_type"
        <?php } ?>
        data-table="records"
...
<script>
loadjs.ready("frecordsadd", function() {
    var options = { name: "x_record_type", selectId: "frecordsadd_x_record_type" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (frecordsadd.lists.record_type?.lookupOptions.length) {
        options.data = { id: "x_record_type", form: "frecordsadd" };
    } else {
        options.ajax = { id: "x_record_type", form: "frecordsadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_records_status">
    <select
        ...
        data-select2-id="frecordsadd_x_status"
        <?php } ?>
        data-table="records"
        data-field="x_status"
...
<script>
loadjs.ready("frecordsadd", function() {
    var options = { name: "x_status", selectId: "frecordsadd_x_status" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (frecordsadd.lists.status?.lookupOptions.length) {
        options.data = { id: "x_status", form: "frecordsadd" };
    } else {
        options.ajax = { id: "x_status", form: "frecordsadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<script>
loadjs.ready(["frecordsadd", "editor"], function() {
    ew.createEditor("frecordsadd", "x_additional_information", 35, 4, <?= $Page->additional_information->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span>
</div></div>
...
<span id="el_records_km_encoded_plaintext_type">
    <select
        ...
        data-select2-id="frecordsadd_x_km_encoded_plaintext_type[]"
        <?php } ?>
        data-table="records"
...
<script>
loadjs.ready("frecordsadd", function() {
    var options = { name: "x_km_encoded_plaintext_type[]", selectId: "frecordsadd_x_km_encoded_plaintext_type[]" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    ...
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (frecordsadd.lists.km_encoded_plaintext_type?.lookupOptions.length) {
        options.data = { id: "x_km_encoded_plaintext_type[]", form: "frecordsadd" };
    } else {
        options.ajax = { id: "x_km_encoded_plaintext_type[]", form: "frecordsadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_records_km_nomenclature_size">
    <select
        ...
        data-select2-id="frecordsadd_x_km_nomenclature_size"
        <?php } ?>
        data-table="records"
...
<script>
loadjs.ready("frecordsadd", function() {
    var options = { name: "x_km_nomenclature_size", selectId: "frecordsadd_x_km_nomenclature_size" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (frecordsadd.lists.km_nomenclature_size?.lookupOptions.length) {
        options.data = { id: "x_km_nomenclature_size", form: "frecordsadd" };
    } else {
        options.ajax = { id: "x_km_nomenclature_size", form: "frecordsadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_records_km_plaintext_arrangement">
    <select
        ...
        data-select2-id="frecordsadd_x_km_plaintext_arrangement[]"
        <?php } ?>
        data-table="records"
...
<script>
loadjs.ready("frecordsadd", function() {
    var options = { name: "x_km_plaintext_arrangement[]", selectId: "frecordsadd_x_km_plaintext_arrangement[]" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.multiple = true;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (frecordsadd.lists.km_plaintext_arrangement?.lookupOptions.length) {
        options.data = { id: "x_km_plaintext_arrangement[]", form: "frecordsadd" };
    } else {
        options.ajax = { id: "x_km_plaintext_arrangement[]", form: "frecordsadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_records_km_ciphertext_arrangement">
    <select
        ...
        data-select2-id="frecordsadd_x_km_ciphertext_arrangement[]"
        <?php } ?>
        data-table="records"
...
<script>
loadjs.ready("frecordsadd", function() {
    var options = { name: "x_km_ciphertext_arrangement[]", selectId: "frecordsadd_x_km_ciphertext_arrangement[]" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.multiple = true;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (frecordsadd.lists.km_ciphertext_arrangement?.lookupOptions.length) {
        options.data = { id: "x_km_ciphertext_arrangement[]", form: "frecordsadd" };
    } else {
        options.ajax = { id: "x_km_ciphertext_arrangement[]", form: "frecordsadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_records_km_memorability">
    <select
        ...
        data-select2-id="frecordsadd_x_km_memorability"
        <?php } ?>
        data-table="records"
...
<script>
loadjs.ready("frecordsadd", function() {
    var options = { name: "x_km_memorability", selectId: "frecordsadd_x_km_memorability" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (frecordsadd.lists.km_memorability?.lookupOptions.length) {
        options.data = { id: "x_km_memorability", form: "frecordsadd" };
    } else {
        options.ajax = { id: "x_km_memorability", form: "frecordsadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_records_km_code_length">
    <select
        ...
        data-select2-id="frecordsadd_x_km_code_length[]"
        <?php } ?>
        data-table="records"
...
<script>
loadjs.ready("frecordsadd", function() {
    var options = { name: "x_km_code_length[]", selectId: "frecordsadd_x_km_code_length[]" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.multiple = true;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (frecordsadd.lists.km_code_length?.lookupOptions.length) {
        options.data = { id: "x_km_code_length[]", form: "frecordsadd" };
    } else {
        options.ajax = { id: "x_km_code_length[]", form: "frecordsadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_records_km_code_type">
    <select
        ...
        data-select2-id="frecordsadd_x_km_code_type[]"
        <?php } ?>
        data-table="records"
...
<script>
loadjs.ready("frecordsadd", function() {
    var options = { name: "x_km_code_type[]", selectId: "frecordsadd_x_km_code_type[]" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.multiple = true;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (frecordsadd.lists.km_code_type?.lookupOptions.length) {
        options.data = { id: "x_km_code_type[]", form: "frecordsadd" };
    } else {
        options.ajax = { id: "x_km_code_type[]", form: "frecordsadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_records_km_material_properties">
    <select
        ...
        data-select2-id="frecordsadd_x_km_material_properties[]"
        <?php } ?>
        data-table="records"
...
<script>
loadjs.ready("frecordsadd", function() {
    var options = { name: "x_km_material_properties[]", selectId: "frecordsadd_x_km_material_properties[]" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.multiple = true;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (frecordsadd.lists.km_material_properties?.lookupOptions.length) {
        options.data = { id: "x_km_material_properties[]", form: "frecordsadd" };
    } else {
        options.ajax = { id: "x_km_material_properties[]", form: "frecordsadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<?php
    if (in_array("images", explode(",", $Page->getCurrentDetailTable())) && $images->DetailAdd) {
?>
...
<?php } ?>
<?php
    if (in_array("documents", explode(",", $Page->getCurrentDetailTable())) && $documents->DetailAdd) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("associated_records", explode(",", $Page->getCurrentDetailTable())) && $associated_records->DetailAdd) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="frecordsadd"><?= $Language->phrase("AddBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="frecordsadd" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
...
loadjs.ready("load", function () {
    ...
    $("<div id=\"horig\" class=\"inlinehead\">Origin</div>").insertBefore("#r_author");
