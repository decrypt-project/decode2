...
?>
<main class="view">
<form name="fcore_contentview" id="fcore_contentview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script>
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id"<?= $Page->id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_core_content_id"><?= $Page->id->caption() ?></span></td>
        <td data-name="id"<?= $Page->id->cellAttributes() ?>>
<span id="el_core_content_id">
...
<?php if ($Page->txkey->Visible) { // txkey ?>
    <tr id="r_txkey"<?= $Page->txkey->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_core_content_txkey"><?= $Page->txkey->caption() ?></span></td>
...
<?php if ($Page->lang->Visible) { // lang ?>
    <tr id="r_lang"<?= $Page->lang->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_core_content_lang"><?= $Page->lang->caption() ?></span></td>
...
<?php if ($Page->_content->Visible) { // content ?>
    <tr id="r__content"<?= $Page->_content->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_core_content__content"><?= $Page->_content->caption() ?></span></td>
